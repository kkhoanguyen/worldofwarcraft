...
L = LibStub("AceLocale-3.0"):NewLocale("Parrot_CombatEvents", "koKR")L[" ([Amount] absorbed)"] = " ([Amount] 흡수됨)"
...
L["<Tag>"] = "<태그>"
L["Abbreviate"] = "약어"
-- L["Abbreviate number values displayed (26500 -> 26.5k)"] = ""
...
L["Filters to be checked for a minimum amount of damage/healing/etc before showing."] = "화면에 표시할 피해/치유/기타 등의 최소값을 설정할 수 있습니다." L["Filters"] = "필터"
L["Font face"] = "글꼴체"
...
L["Whether to merge mass events into single instances instead of excessive spam."] = "많은 이벤트로 인한 지나친 메시지 대신 단 하나의 메시지를 표시합니다." L["Which scroll area to use."] = "사용할 스크롤 영역을 선택합니다."
...
L["Are you sure?"] = "정말로 하시겠습니까?"
L["Check periodically"] = "매 XX 초마다 체크" -- Needs review
L["Classes"] = "직업"
...
L = LibStub("AceLocale-3.0"):NewLocale("Parrot_PointGains", "koKR")
-- L["Currency gains"] = "Currency gains"
L["Experience gains"] = "경험치 획득"
-- L["Name of the currency"] = "ame of the currency"
L["Reputation"] = "평판"
...
L["In a group"] = "파티나 공격대시" -- Needs review
...
L["Spell name or spell id"] = "주문의 이름이나 주문 ID" -- Needs review
L["Successful spell cast"] = "주문 시전 성공"
L["Target is NPC"] = "대상 NPC"
L["Target is player"] = "대상 플레이어"
L["The unit that attacked you"] = "당신을 공격한 유닛"
L["The unit that casted the spell"] = "주문 시전 유닛" -- Needs review
L["The unit that is affected"] = "영향을 받는 유닛"
L["The unit that started the cast"] = "시전 시작 유닛" -- Needs review
