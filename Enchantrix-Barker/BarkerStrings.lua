...
EnchantrixBarkerLocalizations = {
	...
	daDK = {
		...
		-- Section: Game Constants
		["AnyWeapon"]	= "Vilkårligt våben";
		["BarkerOpening"]	= "Enchants til salg:";
		["Boots"]	= "Sko";
		["Bracer"]	= "Ambånd";
		["Chest"]	= "Bryst armering";
		["Cloak"]	= "Kappe";
		["Darnassus"]	= "Darnassus";
		["Enchanting"]	= "Enchanting";
		["EnchSearchAgility"]	= "Hurtighed";
		...
		["EnchSearchAllStats"]	= "alle attributer";
		["EnchSearchArmor"]	= "armering";
		["EnchSearchBattlemaster"]	= "healer et gruppe medlem";
		["EnchSearchBeastslayer"]	= "skade til beasts";
		["EnchSearchBoarSpeed"]	= "Hurtigere løb og [0-9]+ udenholdenlighed";
		["EnchSearchCatSwiftness"]	= "giver dig mere run speed og [0-9]+ hurtighed";
		["EnchSearchCrusader"]	= "healer for [0-9]+ til [0-9]+ og giver mere styrke";
		["EnchSearchDamage1"]	= "point? af skade";
		["EnchSearchDamage2"]	= "\+[0-9]+ skade";
		["EnchSearchDefense"]	= "defensiv";
		["EnchSearchDMGAbsorption"]	= "absorberende";
		["EnchSearchFireRes"]	= "Ild resistance";
		["EnchSearchFrostRes"]	= "frost resistance";
		["EnchSearchHealing"]	= "healing";
		["EnchSearchHealth"]	= "Liv";
		["EnchSearchIntellect"]	= "klogskab";
		["EnchSearchMana"]	= "mana";
		["EnchSearchManaPerFive"]	= "mana hvert 5 sekund";
		["EnchSearchMongoose"]	= "giver [0-9]+ mere hurtighed";
		["EnchSearchNatureRes"]	= "natur resistance";
		["EnchSearchResFire"]	= "resistance til ild";
		["EnchSearchResShadow"]	= "resistance til skygge";
		["EnchSearchSoulfrost"]	= "frost og skygge angreb";
		["EnchSearchSpellPower1"]	= "skade til angreb";
		["EnchSearchSpellPower2"]	= "skade til alle angreb";
		["EnchSearchSpellPower3"]	= "angrebs skade";
		["EnchSearchSpellsurge"]	= "restorere [0-9]+ mana til alle gruppe medlemmer";
		["EnchSearchSpirit"]	= "sjæl";
		["EnchSearchStamina"]	= "udenholdenlighed";
		["EnchSearchStrength"]	= "styrke";
		["EnchSearchSunfire"]	= "ild og arcane angreb";
		["EnchSearchVitality"]	= "restorere [0-9]+ liv og mana";
		["Gloves"]	= "Handsker";
		["Ironforge"]	= "Byen Ironforge";
		["OneLetterGold"]	= "g";
		["OneLetterSilver"]	= "s";
		["Orgrimmar"]	= "Orgrimmar";
		["Ring"]	= "Ring";
		["Shattrath"]	= "Byen Shattrath";
		["Shield"]	= "Skjold";
		["ShortDarnassus"]	= "Darna";
		["ShortExodar"]	= "Exo";
		["ShortIronForge"]	= "IF";
		["ShortOrgrimmar"]	= "Org";
		["ShortShattrath"]	= "Shatt";
		["ShortSilvermoon"]	= "Silvermoon";
		["ShortStormwind"]	= "SW";
		["ShortThunderBluff"]	= "TB";
		["ShortUndercity"]	= "UC";
		["SilvermoonCity"]	= "Byen Silvermoon";
		["StormwindCity"]	= "Byen Stormwind";
		["TheExodar"]	= "Exodar";
		["ThunderBluff"]	= "Byen Thunder Bluff";
		["TradeChannel"]	= "Køb & Salg - By";
		["TwoHandWeapon"]	= "2 håndsvåben";
		["Undercity"]	= "Undercity";
		["Weapon"]	= "Våben";

		-- Section: Generic Messages
		["BarkerLoaded"]	= "Enchantrix Barker læser...";
		["BarkerNotTradeZone"]	= "Enchantrix Barker: Du er ikke i en Køb & Salg zone.";
		...
		["INT"]	= "INT";
		["NatureRes"]	= "natur res";
		["ShadowRes"]	= "skygge res";
		["ShortAllRes"]	= "alle res";
		["ShortArmor"]	= "panser";
	...
	deDE = {
		...
		["BarkerNoEnchantsAvail"]	= "Enchantrix: Du hast entweder keine Verzauberungen oder keine/zu wenig Reagenzien, um sie herzustellen.";
		...
		["EnchSearchAllResistance1"]	= "Widerstand gegen alle Arten von Magie";
		["EnchSearchAllResistance2"]	= "Widerstand gegen alle Magiearten";
		["EnchSearchAllResistance3"]	= "alle Widerstände";
		["EnchSearchAllStats"]	= "alle Werte";
		["EnchSearchArmor"]	= "Rüstung";
		["EnchSearchBattlemaster"]	= "heilt nahestehende Gruppenmitglieder";
		["EnchSearchBeastslayer"]	= "Schaden gegen Wildtiere";
		["EnchSearchBoarSpeed"]	= "Erhöht die Bewegungsgeschwindigkeit und [0-9]+ Ausdauer";
		["EnchSearchCatSwiftness"]	= "Erhöht die Bewegungsgeschwindigkeit und [0-9]+ Beweglichkeit";
		["EnchSearchCrusader"]	= "heilt für [0-9]+ bis [0-9]+ und erhöht Stärke";
		...
		["EnchSearchResilience"]	= "Zähigkeit";
		["EnchSearchResShadow"]	= "Schattenwiderstand";
		["EnchSearchSoulfrost"]	= "Frost- und Schattenzauber";
		["EnchSearchSpellPower1"]	= "Schaden zu Zaubersprüchen";
		["EnchSearchSpellPower2"]	= "Schaden zu allen Zaubersprüchen";
		["EnchSearchSpellPower3"]	= "Zauberschaden";
		["EnchSearchSpellsurge"]	= "bei allen Gruppenmitgliedern 10 Sekunden lang 100 Mana wiederherstellen";
		["EnchSearchSpirit"]	= "Wille";
		...
		["FrmtWarnAuctNotLoaded"]	= "[Auctioneer nicht geladen, es werden zwischengespeicherte Preise benutzt]";
		...
		["BarkerOptionsHighestPriceForFactorTitle"]	= "Preisfaktor Höchster";
		...
		["BarkerOptionsHighestProfitTooltip"]	= "Höchstmöglicher Gewinn für eine Entzauberung.";
		...
		["BarkerOptionsOtherTooltip"]	= "Die Prioritätsstufe für Verzauberungen wie z.B. Kürschnerei, Bergbau, Reiten etc.";
		...
		["BarkerOptionsProfitMarginTooltip"]	= "Preisaufschlag auf die Materialkosten in Prozent.";
		["BarkerOptionsRandomFactorTitle"]	= "Zufallsfaktor";
		["BarkerOptionsRandomFactorTooltip"]	= "Zufallsfaktor der Auswahl der Verzauberungen für Handelsausrufe.";
		["BarkerOptionsResiliencePriority"]	= "Zähigkeit";
		["BarkerOptionsResiliencePriorityTooltip"]	= "Die Prioritätsstufe für Zähigkeitsverzauberungen.";
	...
	enUS = {
		...
		["EnchSearchResilience"]	= "Resilience";
		...
		["BarkerOptionsResiliencePriority"]	= "Resilience";
		["BarkerOptionsResiliencePriorityTooltip"]	= "The priority score for resilience enchants.";
	...
	esES = {
		...
		["EnchSearchAllResistance1"]	= "resistencia a todas las escuelas de magia";
		["EnchSearchAllResistance2"]	= "resistencia a todas escuelas mágicas";
		["EnchSearchAllResistance3"]	= "todas resistencias";
		["EnchSearchAllStats"]	= "todas estadísticas";
		["EnchSearchArmor"]	= "armadura";
		["EnchSearchBattlemaster"]	= "cura a miembros del grupo cercanos";
		["EnchSearchBeastslayer"]	= "daño a bestias";
		["EnchSearchBoarSpeed"]	= "velocidad de movimiento aumentada y [0-9]+ de aguante";
		["EnchSearchCatSwiftness"]	= "velocidad de movimiento aumentada y [0-9]+ de agilidad";
		["EnchSearchCrusader"]	= "cura de [0-9]+ a [0-9]+ e incrementa la fuerza";
		["EnchSearchDamage1"]	= "puntos? de daño";
		["EnchSearchDamage2"]	= "\+[0-9]+ de daño";
		["EnchSearchDefense"]	= "defensa";
		["EnchSearchDMGAbsorption"]	= "absorción";
		["EnchSearchFireRes"]	= "resistencia al fuego";
		["EnchSearchFrostRes"]	= "resistencia a la escarcha";
		["EnchSearchHealing"]	= "curación";
		...
		["EnchSearchSunfire"]	= "hechizos arcanos y de fuego";
		["EnchSearchVitality"]	= "restaura [0-9]+ de vida y maná";
		["Gloves"]	= "Guantes";
		["Ironforge"]	= "Forjaz";
		["OneLetterGold"]	= "o";
		["OneLetterSilver"]	= "p";
		...
		["ShortUndercity"]	= "E";
		["SilvermoonCity"]	= "Claro de Luna";
		["StormwindCity"]	= "Ventormenta";
		["TheExodar"]	= "Exodar";
		["ThunderBluff"]	= "Cima del Trueno";
		["TradeChannel"]	= "Comercio - Ciudad";
		["TwoHandWeapon"]	= "Arma 2M";
		["Undercity"]	= "Entrañas";
		["Weapon"]	= "Arma";

		-- Section: Generic Messages
		["BarkerLoaded"]	= "Enchantrix Barker Cargado...";
		["BarkerNotTradeZone"]	= "Enchantrix Barker: Usted no esta en una zona de intercambio.";
		...
		["BarkerOptionsAgilityPriority"]	= "agilidad";
		["BarkerOptionsAgilityPriorityTooltip"]	= "La prioridad de puntuación para los encantamientos de agilidad.";
		["BarkerOptionsAllResistances"]	= "todas las resistencias";
		...
		["BarkerOptionsDamageTooltip"]	= "La prioridad de puntuación para los encantamientos de daño.";
		["BarkerOptionsDefense"]	= "defensa";
		["BarkerOptionsDefenseTooltip"]	= "La prioridad de puntuación para los encantamientos de defensa.";
		["BarkerOptionsFireResistance"]	= "resistencia al fuego";
		["BarkerOptionsFireResistanceTooltip"]	= "La prioridad de puntuación para los encantamientos de resistencia al fuego.";
		["BarkerOptionsFrostResistance"]	= "resistencia al hielo";
		["BarkerOptionsFrostResistanceTooltip"]	= "La prioridad de puntuación para los encantamientos de resistencia al hielo.";
		["BarkerOptionsGlovesPriorityTooltip"]	= "La prioridad de puntuación para los encantamientos de guante.";
		["BarkerOptionsHealth"]	= "salud";
		["BarkerOptionsHealthTooltip"]	= "La prioridad de puntuación para los encantamientos de salud.";
		...
		["BarkerOptionsHighestProfitTooltip"]	= "El beneficio máximo de dinero a conseguir en un encantamiento";
		...
		["BarkerOptionsMana"]	= "Mana";
		["BarkerOptionsManaTooltip"]	= "La prioridad de puntuación para los encantamientos de mana.";
		["BarkerOptionsNatureResistance"]	= "Resistencia a la naturaleza";
		["BarkerOptionsNatureResistanceTooltip"]	= "La prioridad de puntuación para los encantamientos de resistencia a la naturaleza.";
		["BarkerOptionsOther"]	= "otros";
		["BarkerOptionsOtherTooltip"]	= "La prioridad de puntuación para los encantamientos como son despellejar, minar, montar, etc.";
		...
		["BarkerOptionsShieldPriorityTooltip"]	= "La prioridad de puntuación para los encantamientos de escudo.";
		["BarkerOptionsSpiritPriority"]	= "espiritu";
		["BarkerOptionsSpiritPriorityTooltip"]	= "La prioridad de puntuación para los encantamientos de espíritu.";
	...
	itIT = {
		...
		["BarkerNotTradeZone"]	= "Enchantrix Barker: non sei in una zona di scambi....";
		...
		["DEF"]	= "Dif";
		["DMG"]	= "DMG";
		["DMGAbsorb"]	= "Assorbimento DMG";
		["FireRes"]	= "resistenza al fuoco";
		["FrostRes"]	= "resistenza al gelo";
		["INT"]	= "Int";
		["NatureRes"]	= "res natura";
		["ShadowRes"]	= "res ombre";
		["ShortAllRes"]	= "tutte le res";
		["ShortArmor"]	= "arm";
		["ShortBeastslayer"]	= "Bestia";
		["ShortHealing"]	= "curare";
		["ShortHealth"]	= "salute";
		["ShortMana"]	= "mana";
		["ShortManaPerFive"]	= "mana/5sec";
		["ShortSpellPower"]	= "incantesimo";
		["ShortVitality"]	= "Vitalità";
		["SPI"]	= "SPI";
		["STA"]	= "Vigore";
		["STR"]	= "Forza";
	...
	koKR = {
		...
		["EnchSearchResilience"]	= "탄력도";
		["EnchSearchResShadow"]	= "암흑 저항력";
		["EnchSearchSoulfrost"]	= "냉기 및 암흑 주문";
		["EnchSearchSpellPower1"]	= "주문의 피해";
		["EnchSearchSpellPower2"]	= "모든 주문의 피해";
		["EnchSearchSpellPower3"]	= "주문 피해";
		...
		["BarkerNotTradeZone"]	= "Enchantrix Barker: 거래지역이 아닙니다.";
		...
		["OpenBarkerWindow"]	= "거래 바커창을 엽니다.";

		-- Section: User Interface
		["BarkerOptions2HWeaponPriorityTooltip"]	= "양손 무기 마부에 우선순위를 둡니다.";
		["BarkerOptionsAgilityPriority"]	= "민첩성";
		["BarkerOptionsAgilityPriorityTooltip"]	= "민첩력 마부에 우선순위를 둡니다.";
		["BarkerOptionsAllResistances"]	= "모든 저항력";
		["BarkerOptionsAllResistancesTooltip"]	= "모든 저항력 증가 마부에 우선순위를 둡니다.";
		["BarkerOptionsAllStatsPriority"]	= "모든 능력치";
		["BarkerOptionsAllStatsPriorityTooltip"]	= "모든 능력치 마부에 우선순위를 둡니다.";
		["BarkerOptionsAnyWeaponPriorityTooltip"]	= "무기 마부에 우선순위를 둡니다.";
		["BarkerOptionsArmorPriority"]	= "방어";
		["BarkerOptionsArmorPriorityTooltip"]	= "갑옷 마부에 우선순위를 둡니다.";
		["BarkerOptionsBootsPriorityTooltip"]	= "신발 마부에 우선순위를 둡니다.";
		["BarkerOptionsBracerPriorityTooltip"]	= "팔보호구 마부에 우선순위를 둡니다.";
		["BarkerOptionsChestPriorityTooltip"]	= "가슴 마부에 우선순위를 둡니다.";
		["BarkerOptionsCloakPriorityTooltip"]	= "망토 마부에 우선순위를 둡니다.";
		["BarkerOptionsDamage"]	= "공격력";
		["BarkerOptionsDamageTooltip"]	= "증뎀 마부에 우선순위를 둡니다.";
		["BarkerOptionsDefense"]	= "방어도";
		["BarkerOptionsDefenseTooltip"]	= "방어 마부에 우선순위를 둡니다.";
		["BarkerOptionsFireResistance"]	= "화염 저항";
		["BarkerOptionsFireResistanceTooltip"]	= "화염 저항력 마부에 우선순위를 둡니다.";
		["BarkerOptionsFrostResistance"]	= "냉기 저항";
		["BarkerOptionsFrostResistanceTooltip"]	= "냉기 저항력 마부에 우선순위를 둡니다.";
		["BarkerOptionsGlovesPriorityTooltip"]	= "장갑 마부에 우선순위를 둡니다.";
		["BarkerOptionsHealth"]	= "생명력";
		["BarkerOptionsHealthTooltip"]	= "생명력 마부에 우선순위를 둡니다.";
		...
		["BarkerOptionsManaTooltip"]	= "마나 마부에 우선순위를 둡니다.";
		["BarkerOptionsNatureResistance"]	= "자연 저항";
		["BarkerOptionsNatureResistanceTooltip"]	= "자연 저항력 마부에 우선순위를 둡니다.";
		...
		["BarkerOptionsResiliencePriority"]	= "탄력도";
		["BarkerOptionsResiliencePriorityTooltip"]	= "탄력도 마부에 우선순위를 둡니다.";
		["BarkerOptionsRingPriorityTooltip"]	= "반지 마부에 우선순위를 둡니다.";
		["BarkerOptionsShadowResistance"]	= "암흑 저항";
		["BarkerOptionsShadowResistanceTooltip"]	= "암흑 저항력 마부에 우선순위를 둡니다.";
		["BarkerOptionsShieldPriorityTooltip"]	= "방패 마부에 우선순위를 둡니다.";
		["BarkerOptionsSpiritPriority"]	= "정신력";
		["BarkerOptionsSpiritPriorityTooltip"]	= "정신력 마부에 우선순위를 둡니다.";
	...
	nlNL = {
		...
		-- Section: Command Messages
		["BarkerEnxWindowNotOpen"]	= "Enchantrix: Het enchanting scherm is niet geopend. Het enchanting scherm moet geopend zijn om de barker te gebruiken.";
		...
		-- Section: Game Constants
		["AnyWeapon"]	= "Elk wapen";
		["BarkerOpening"]	= "Verkoop van betoveringen";
		["Boots"]	= "Laarzen";
		["Bracer"]	= "Armband";
		["Chest"]	= "Borst";
		["Cloak"]	= "Cape";
		["Darnassus"]	= "Darnassus";
		["Enchanting"]	= "Betoveren";
		["EnchSearchAgility"]	= "behendigheid";
		["EnchSearchAllResistance1"]	= "weerstand tegen alle betoveringsklassen";
		["EnchSearchAllResistance2"]	= "weerstand tegen alle betoveringsklassen";
		["EnchSearchAllResistance3"]	= "alle weerstanden";
		["EnchSearchAllStats"]	= "alle stats";
		["EnchSearchArmor"]	= "bepantsering";
		["EnchSearchBattlemaster"]	= "genees alle groepsgenoten die dicht bij zijn";
		["EnchSearchBeastslayer"]	= "Schade aan beesten";
		["EnchSearchBoarSpeed"]	= "bewegingssnelheid vergroting en [0-9]+ conditie";
		["EnchSearchCatSwiftness"]	= "bewegingssnelheid vergroting en [0-9]+ behendigheid";
		["EnchSearchCrusader"]	= "geneest voor [0-9]+ tot [0-9]+ en vergroot kracht";
		["EnchSearchDamage1"]	= "punten? van schade";
		["EnchSearchDamage2"]	= "\+[0-9]+ schade";
		["EnchSearchDefense"]	= "verdediging";
		["EnchSearchDMGAbsorption"]	= "opnemen";
		["EnchSearchFireRes"]	= "weerstand tegen vuur";
		["EnchSearchFrostRes"]	= "weerstand tegen bevriezing";
		["EnchSearchHealing"]	= "genezing";
		["EnchSearchHealth"]	= "leven";
		["EnchSearchIntellect"]	= "intellect";
		["EnchSearchMana"]	= "mana";
		["EnchSearchManaPerFive"]	= "mana elke 5 seconden";
		["EnchSearchMongoose"]	= "vergroot behendigheid met [0-9]+ en aanval snelheid";
		["EnchSearchNatureRes"]	= "weerstand tegen natuur";
		["EnchSearchResFire"]	= "weerstand tegen vuur";
		["EnchSearchResShadow"]	= "weerstand tegen schaduw";
		["EnchSearchSoulfrost"]	= "bevriezings- en schaduwbetoveringen";
		["EnchSearchSpellPower1"]	= "schade voor betoveringen";
		["EnchSearchSpellPower2"]	= "schade voor alle betoveringen";
		["EnchSearchSpellPower3"]	= "betoveringsschade";
		["EnchSearchSpellsurge"]	= "herstel [0-9]+ mana naar elk party lid";
		["EnchSearchSpirit"]	= "ziel";
		["EnchSearchStamina"]	= "conditie";
		["EnchSearchStrength"]	= "kracht";
		["EnchSearchSunfire"]	= "vuur en arcane betoveringen";
		["EnchSearchVitality"]	= "herstel [0-9]+ leven en mana";
		["Gloves"]	= "Handschoenen";
		["Ironforge"]	= "City of Ironforge";
		["OneLetterGold"]	= "g";
		["OneLetterSilver"]	= "s";
		...
		["DEF"]	= "DEF";
		["DMG"]	= "DMG";
		["DMGAbsorb"]	= "DMG absorbtie";
		["FrostRes"]	= "Ijsresistentie";
		["INT"]	= "INT";
		["NatureRes"]	= "Natuurresistentie";
		["ShadowRes"]	= "Schaduwresistentie";
		["ShortAllRes"]	= "Alle Resistenties";
		["ShortArmor"]	= "bepantsering";
		["ShortBattlemaster"]	= "Battlemaster";
		["ShortBeastslayer"]	= "Beast";
		["ShortBoarSpeed"]	= "Boar Speed";
		["ShortCatSwiftness"]	= "Cat Swiftness";
		["ShortHealing"]	= "genezing";
		["ShortHealth"]	= "gezondheid";
		["ShortMana"]	= "mana";
		["ShortManaPerFive"]	= "mana/5sec";
		["ShortMongoose"]	= "Mongoose";
		["ShortSoulfrost"]	= "Soulfrost";
		...
		-- Section: User Interface
		["BarkerOptions2HWeaponPriorityTooltip"]	= "Prioriteitsscrore voor 2h wapen enchants";
		["BarkerOptionsAgilityPriority"]	= "Agility";
		["BarkerOptionsAgilityPriorityTooltip"]	= "Prioriteitsscore voor Agility enchants";
		["BarkerOptionsAllResistances"]	= "Alle Resistenties";
		["BarkerOptionsAllResistancesTooltip"]	= "Prioriteitsscore voor enchants die alle resistenties verhogen";
		["BarkerOptionsAllStatsPriority"]	= "Alle Statistieken";
		["BarkerOptionsAllStatsPriorityTooltip"]	= "Prioriteitsscore voor enchants die alle statistieken verhogen";
		["BarkerOptionsAnyWeaponPriorityTooltip"]	= "Prioriteitsscore voor enchants voor elk wapen";
		["BarkerOptionsArmorPriority"]	= "Bepantsering";
		["BarkerOptionsArmorPriorityTooltip"]	= "Prioriteitsscore voor bepantserings enchants";
		["BarkerOptionsBootsPriorityTooltip"]	= "Prioriteitsscore voor laarzen enchants";
		["BarkerOptionsDamage"]	= "Schade";
		["BarkerOptionsDefense"]	= "Verdediging";
		["BarkerOptionsFireResistance"]	= "Vuurbestendig";
		["BarkerOptionsFrostResistance"]	= "Vorstbestendig";
		["BarkerOptionsHealth"]	= "Gezondheid";
		["BarkerOptionsHighestProfitTitle"]	= "Maximale Winst";
		["BarkerOptionsLowestPriceTitle"]	= "Laagste Prijs";
		["BarkerOptionsNatureResistance"]	= "Natuurbestendig";
	...
	ruRU = {
		...
		-- Section: Command Messages
		["BarkerEnxWindowNotOpen"]	= "Окно зачарования закрыто. Необходимо открыть окно зачарования для использования аукциониста.";
		...
		-- Section: Game Constants
		["AnyWeapon"]	= "Любое оружие";
		["BarkerOpening"]	= "Продаю чары:";
		["Boots"]	= "Обувь";
		["Bracer"]	= "Наручи";
		["Chest"]	= "Нагрудник";
		["Cloak"]	= "Плащ";
		...
		["EnchSearchAgility"]	= "ловкость";
		["EnchSearchAllResistance1"]	= "сопротивление всем школам магии";
		["EnchSearchAllResistance2"]	= "сопротивление всем магическим школам";
		["EnchSearchAllResistance3"]	= "все сопротивления";
		["EnchSearchAllStats"]	= "все атрибуты";
		["EnchSearchArmor"]	= "броня";
		["EnchSearchBattlemaster"]	= "лечит членов группы вблизи";
		["EnchSearchBeastslayer"]	= "урон животным";
		["EnchSearchBoarSpeed"]	= "увеличение скорости передвижения и [0-9]+ выносливости";
		["EnchSearchCatSwiftness"]	= "увеличение скорости передвижения и [0-9]+ ловкости";
		["EnchSearchCrusader"]	= "лечит от [0-9]+ до [0-9]+ и увеличивает силу";
		["EnchSearchDamage1"]	= "единиц? урона";
		["EnchSearchDamage2"]	= "\+[0-9]+ урона";
		["EnchSearchDefense"]	= "защита";
		["EnchSearchDMGAbsorption"]	= "поглощение";
		["EnchSearchFireRes"]	= "огнеустойчивость";
		["EnchSearchFrostRes"]	= "холодоустойчивость";
		["EnchSearchHealing"]	= "лечение";
		["EnchSearchHealth"]	= "здоровье";
		["EnchSearchIntellect"]	= "интеллект";
		["EnchSearchMana"]	= "мана";
		["EnchSearchManaPerFive"]	= "маны каждые 5 секунд";
		["EnchSearchMongoose"]	= "увеличивает ловкость на [0-9]+ и скорость атаки";
		["EnchSearchNatureRes"]	= "сопротивлении магии природы";
		["EnchSearchResFire"]	= "сопротивление огню";
		["EnchSearchResilience"]	= "Сопротивление";
		["EnchSearchResShadow"]	= "сопротивление тьме";
		["EnchSearchSoulfrost"]	= "заклинания холода и тьмы";
		["EnchSearchSpellPower1"]	= "урон заклинаний";
		["EnchSearchSpellPower2"]	= "урон всех заклинаний";
		["EnchSearchSpellPower3"]	= "урон от заклинаний";
		["EnchSearchSpellsurge"]	= "восстанавливает [0-9]+ маны всем членам группы";
		["EnchSearchSpirit"]	= "дух";
		["EnchSearchStamina"]	= "выносливость";
		["EnchSearchStrength"]	= "сила";
		["EnchSearchSunfire"]	= "заклинания огня и аркана";
		["EnchSearchVitality"]	= "восстанавливает [0-9]+ здоровья и маны";
		["Gloves"]	= "Перчатки";
		["Ironforge"]	= "Стальгорн";
		["OneLetterGold"]	= "з";
		["OneLetterSilver"]	= "с";
		...
		["FireRes"]	= "сопр.огню";
		["FrostRes"]	= "сопр.холоду";
		["INT"]	= "инт";
		["NatureRes"]	= "сопр.природе";
		["ShadowRes"]	= "сопр.тени";
		...
		-- Section: User Interface
		["BarkerOptions2HWeaponPriorityTooltip"]	= "Приоритетность чар для двуручного оружия";
		["BarkerOptionsAgilityPriority"]	= "Ловкость";
		["BarkerOptionsAgilityPriorityTooltip"]	= "Приоритетность чар для ловкости";
		["BarkerOptionsAllResistances"]	= "Все сопротивления";
		["BarkerOptionsAllResistancesTooltip"]	= "Приоритетность чар, повышающих все сопротивления";
		["BarkerOptionsAllStatsPriority"]	= "Все атрибуты";
		["BarkerOptionsAllStatsPriorityTooltip"]	= "Приоритетность чар, увеличивающих все атрибуты";
		["BarkerOptionsAnyWeaponPriorityTooltip"]	= "Приоритетность чар для любого оружия";
		["BarkerOptionsArmorPriority"]	= "Броня";
		["BarkerOptionsArmorPriorityTooltip"]	= "Приоритетность чар для брони";
		["BarkerOptionsBootsPriorityTooltip"]	= "Приоритетность чар для обуви";
		["BarkerOptionsBracerPriorityTooltip"]	= "Приоритетность чар для наручей";
		["BarkerOptionsChestPriorityTooltip"]	= "Приоритетность чар для нагрудников";
		["BarkerOptionsCloakPriorityTooltip"]	= "Приоритетность чар для плащей";
		["BarkerOptionsDamage"]	= "Урон";
		["BarkerOptionsDamageTooltip"]	= "Приоритетность чар для повышения урона";
		["BarkerOptionsDefense"]	= "Защита";
		["BarkerOptionsDefenseTooltip"]	= "Приоритетность чар для повышения защиты";
		["BarkerOptionsFireResistance"]	= "Сопротивление огню";
		["BarkerOptionsFireResistanceTooltip"]	= "Приоритетность чар для сопротивления огню";
		["BarkerOptionsFrostResistance"]	= "Сопротивление холоду";
		["BarkerOptionsFrostResistanceTooltip"]	= "Приоритетность чар для сопротивления холоду";
		["BarkerOptionsGlovesPriorityTooltip"]	= "Приоритетность чар для перчаток";
		["BarkerOptionsHealth"]	= "Здоровье";
		["BarkerOptionsHealthTooltip"]	= "Приоритетность чар для здоровья";
		["BarkerOptionsHighestPriceForFactorTitle"]	= "Высокий ценовой Фактор";
		["BarkerOptionsHighestPriceForFactorTooltip"]	= "Очаровывает получают нулевое значение для ценового приоритета или выше этого значения.";
		["BarkerOptionsHighestProfitTitle"]	= "Максимальная прибыль";
		["BarkerOptionsHighestProfitTooltip"]	= "Самый высокий полный наличный доход, чтобы сделать зачарование.";
		["BarkerOptionsIntellectPriority"]	= "Интеллект";
		["BarkerOptionsIntellectPriorityTooltip"]	= "Приоритетность чар для интеллекта";
		["BarkerOptionsItemsPriority"]	= "Полный приоритет вещей";
		["BarkerOptionsItemsPriorityTooltip"]	= "Это устанавливает, как важен элемент полный приоритет для рекламирования.";
		["BarkerOptionsLowestPriceTitle"]	= "Низшая цена";
		["BarkerOptionsLowestPriceTooltip"]	= "Минимальная цена, чтобы писать для зачарования";
		...
		["BarkerOptionsRandomFactorTitle"]	= "Случайный фактор";
		["BarkerOptionsRandomFactorTooltip"]	= "Количество случайности в зачаровании для торгового крика.";
		["BarkerOptionsResiliencePriority"]	= "Сопротивление";
		["BarkerOptionsResiliencePriorityTooltip"]	= "Оценка приоритета для устойчивости зачарования.";
		["BarkerOptionsRingPriorityTooltip"]	= "Приоритет для зачарования кольца";
		["BarkerOptionsShadowResistance"]	= "Сопротивление магии тени";
	...
	zhCN = {
		...
		["BarkerOptionsHighestPriceForFactorTitle"]	= "价格因素至最高";
		["BarkerOptionsHighestPriceForFactorTooltip"]	= "大于或等于此价格时附魔让价格优先得零分。";
		...
		["BarkerOptionsResiliencePriority"]	= "韧性";
		["BarkerOptionsResiliencePriorityTooltip"]	= "优先显示附魔-韧性";
	...
	zhTW = {
		...
		["EnchSearchAllStats"]	= "全屬性";
		["EnchSearchArmor"]	= "護甲";
		["EnchSearchBattlemaster"]	= "治療附近同伴";
		["EnchSearchBeastslayer"]	= "對野獸傷害";
		["EnchSearchBoarSpeed"]	= "移動速度提昇和[0-9]+耐力";
		["EnchSearchCatSwiftness"]	= "移動速度提昇和[0-9]+敏捷";
		["EnchSearchCrusader"]	= "治療[0-9]+ 到 [0-9]+和提昇力量";
		["EnchSearchDamage1"]	= "?傷害點數";
		["EnchSearchDamage2"]	= "\+[0-9]+傷害";
		["EnchSearchDefense"]	= "防禦";
		["EnchSearchDMGAbsorption"]	= "吸收";
		["EnchSearchFireRes"]	= "火炎抗性";
		["EnchSearchFrostRes"]	= "冰霜抗性";
		["EnchSearchHealing"]	= "治療";
		["EnchSearchHealth"]	= "生命";
		["EnchSearchIntellect"]	= "智力";
		["EnchSearchMana"]	= "法力";
		["EnchSearchManaPerFive"]	= "5秒回魔";
		["EnchSearchMongoose"]	= "增加敏捷[0-9]+及攻擊速度";
		["EnchSearchNatureRes"]	= "自然抗性";
		["EnchSearchResFire"]	= "火抗";
		["EnchSearchResilience"]	= "韌性";
		["EnchSearchResShadow"]	= "暗抗";
		["EnchSearchSoulfrost"]	= "冰霜和暗影技能";
		["EnchSearchSpellPower1"]	= "法術傷害";
		["EnchSearchSpellPower2"]	= "法術傷害";
		["EnchSearchSpellPower3"]	= "法術傷害";
		["EnchSearchSpellsurge"]	= "回復附近小隊隊員[0-9]+法力";
		["EnchSearchSpirit"]	= "精神";
		["EnchSearchStamina"]	= "耐力";
		["EnchSearchStrength"]	= "力量";
		["EnchSearchSunfire"]	= "火焰與奧術法術";
		["EnchSearchVitality"]	= "回復[0-9]+生命力與法力";
		["Gloves"]	= "手套";
		["Ironforge"]	= "鐵爐堡";
		["OneLetterGold"]	= "金";
		["OneLetterSilver"]	= "銀";
		...
		-- Section: Generic Messages
		["BarkerLoaded"]	= "附魔助手載入中...";
		["BarkerNotTradeZone"]	= "附魔助手：您不在交易區";
		...
		["ShortHealth"]	= "生命";
		["ShortMana"]	= "法力";
		["ShortManaPerFive"]	= "五秒回魔";
		["ShortMongoose"]	= "貓鼬";
		["ShortSoulfrost"]	= "靈魂冰霜";
		["ShortSpellPower"]	= "法術力量";
		["ShortSpellSurge"]	= "法力回流";
		["ShortSunfire"]	= "烈日火焰";
		["ShortVitality"]	= "生命力";
		["SPI"]	= "精神";
		...
		["BarkerOptionsDamageTooltip"]	= "優先顯示附魔-傷害";
		...
		["BarkerOptionsHighestPriceForFactorTitle"]	= "價格因素至最高";
		["BarkerOptionsHighestPriceForFactorTooltip"]	= "大於或等於此價格時，副魔讓價格優先得零分";
		["BarkerOptionsHighestProfitTitle"]	= "最高盈利";
		["BarkerOptionsHighestProfitTooltip"]	= "附魔所收到的最高收益";
		["BarkerOptionsIntellectPriority"]	= "智力";
		["BarkerOptionsIntellectPriorityTooltip"]	= "優先顯示附魔-智力";
		["BarkerOptionsItemsPriority"]	= "整體物品優先";
		["BarkerOptionsItemsPriorityTooltip"]	= "這將設定多重要的物品來決定廣告時的總體優先度。";
		["BarkerOptionsLowestPriceTitle"]	= "最低價格";
		["BarkerOptionsLowestPriceTooltip"]	= "提供附魔的最低現金報價。";
		["BarkerOptionsMana"]	= "法力";
		["BarkerOptionsManaTooltip"]	= "優先顯示附魔-法力";
		["BarkerOptionsNatureResistance"]	= "自抗";
		["BarkerOptionsNatureResistanceTooltip"]	= "優先顯示附魔-自抗";
		["BarkerOptionsOther"]	= "其他";
		["BarkerOptionsOtherTooltip"]	= "優先顯示附魔-剝皮，採礦，騎術等";
		["BarkerOptionsPricePriorityTitle"]	= "整體價格優先";
		["BarkerOptionsPricePriorityTooltip"]	= "這將設定多大的價格來決定廣告時的總體優先度。";
		["BarkerOptionsPriceSweetspotTitle"]	= "價格係數甜蜜點";
		["BarkerOptionsPriceSweetspotTooltip"]	= "這是用來決定廣告時位於此價格附近的附魔。";
		["BarkerOptionsProfitMarginTitle"]	= "淨利率";
		["BarkerOptionsProfitMarginTooltip"]	= "增加利潤比例到基本邊際收益費用";
		["BarkerOptionsRandomFactorTitle"]	= "隨機要素";
		["BarkerOptionsRandomFactorTooltip"]	= "交易吆喝時隨機選擇的附魔數量";
		["BarkerOptionsResiliencePriority"]	= "韌性";
		["BarkerOptionsResiliencePriorityTooltip"]	= "優先顯示附魔-韌性";
		["BarkerOptionsRingPriorityTooltip"]	= "優先顯示附魔-戒指";
		["BarkerOptionsShadowResistance"]	= "暗抗";
		["BarkerOptionsShadowResistanceTooltip"]	= "優先顯示附魔-暗抗";
		["BarkerOptionsShieldPriorityTooltip"]	= "優先顯示附魔-盾牌";
		["BarkerOptionsSpiritPriority"]	= "精神";
		["BarkerOptionsSpiritPriorityTooltip"]	= "優先顯示附魔-精神";
		["BarkerOptionsStaminaPriority"]	= "耐力";
		["BarkerOptionsStaminaPriorityTooltip"]	= "優先顯示附魔-耐力";
		["BarkerOptionsStatsPriority"]	= "整體屬性優先";
		["BarkerOptionsStatsPriorityTooltip"]	= "這將設定多重要的價格來決定廣告時的總體優先度。";
		["BarkerOptionsStrengthPriority"]	= "力量";
		["BarkerOptionsStrengthPriorityTooltip"]	= "優先顯示附魔-力量";
		["BarkerOptionsTab1Title"]	= "利潤和價格優先度";
